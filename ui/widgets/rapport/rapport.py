...
from constants.stylesheets import yellow_20_label_stylesheet, black_16_label_stylesheet, red_16_bold_label_stylesheet, green_16_bold_label_stylesheet, orange_16_bold_label_stylesheet, dune_title_stylesheet
...
class Rapport(MondonWidget):
    ...
    def create_master_title(self):
        ...
        master_title = QLabel("Rapport production bobine")
        master_title.setFixedSize(300, self.TITLE_H)
    ...
    def create_chart(self):
        chart = Chart(mode="rapport")
        chart.setFixedSize(700, 200)
        return chart
