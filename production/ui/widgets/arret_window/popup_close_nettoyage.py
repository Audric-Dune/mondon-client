...
class PopupCloseNettoyage(QWidget):
    ...
    """
    Popup d'avertissement pas de raison prévu ou imprévu sélectionné
    """

    def __init__(self, onclose, parent=None):
        super(PopupCloseNettoyage, self).__init__(parent=parent)
    ...
    def create_icone(self):
        ...
        img = QPixmap("commun/assets/images/icone_error.png")
    ...
    def create_message():
        vbox = QVBoxLayout()
        label1 = QLabel("Aucune raison prévue ou imprévue sélectionnée.")
    ...
    def onclick_button(self, bool):
        ...
        """
        self.POPUP_CLOSE_NETTOYAGE_SIGNAL.emit(bool)
