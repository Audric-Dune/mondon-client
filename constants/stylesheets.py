...
red_14_label_stylesheet = create_qlabel_stylesheet(color=color_blanc, background_color=color_rouge, font_size="14px")
...
blue_14_label_stylesheet = create_qlabel_stylesheet(color=color_blanc, background_color=color_bleu, font_size="14px")
...
green_14_label_stylesheet = create_qlabel_stylesheet(color=color_blanc, background_color=color_vert_fonce, font_size="14px")
...
gray_14_label_stylesheet = create_qlabel_stylesheet(color=color_noir, background_color=color_gris_moyen, font_size="14px")
gris_moyen_label_stylesheet = create_qlabel_stylesheet(color=color_blanc, background_color=color_gris_moyen, font_size="16px")
